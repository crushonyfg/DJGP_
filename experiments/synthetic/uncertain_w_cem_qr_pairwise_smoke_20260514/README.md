...
Smoke run for the parser/gradient changes logged in `docs/experiments_log.md`,
section `2026-05-14 - uncertain_w_cem_qr_pairwise_seed0_20260514`.
...
```json
{
  "started": "2026-05-14 22:02:07",
  "finished": "2026-05-14 22:02:11",
  "device": "cuda",
  "args": {
    "settings": "l2_q2_train1000",
    "variants": "qr_alt_refresh2_self_cem1_nstd0.1_pair0.05_kcov0.1",
    "seed_start": 0,
    "num_exp": 1,
    "projection_init": "pls",
    "max_test": 5,
    ...
    "resume": false,
    "out_dir": "experiments\\synthetic\\uncertain_w_cem_qr_pairwise_smoke_20260514"
  },
  "settings": {
    "l2_q2_train1000": {
      "family": "L2_phantom",
  ...
  "variants": [
    "qr_alt_refresh2_self_cem1_nstd0.1_pair0.05_kcov0.1"
  ],
  "n_rows": 2,
  "n_ok": 2,
  "n_failed": 0
