...
Headline: the seed0 hybrid-anchor retrieval gain did not survive this 5-seed
LH validation.  `qr_alt_hya0.25...` averaged RMSE/CRPS `611.81/260.54` and
`qr_alt_hya0.4...` averaged `623.56/269.48`, while train-anchor raw qR averaged
`590.71/250.42` and no-qR raw self-CEM2 averaged `595.68/252.28`.
...
```json
{
  "started": "2026-05-16 19:11:23",
  "finished": "2026-05-16 20:27:42",
  "device": "cuda",
  "args": {
    "settings": "lh_q5_train1000",
    "variants": "qr_alt_refresh10_self_cem2_nstd0.1_kcov0.1,self_cem2_nstd0.1_kcov0.1,qr_alt_hya0.25_refresh10_self_cem2_nstd0.1_rank0.1_kcov0.1,qr_alt_hya0.4_refresh10_self_cem2_nstd0.1_rank0.1_kcov0.1",
    "seed_start": 0,
    "num_exp": 5,
    "projection_init": "pls",
    "max_test": 200,
    ...
    "resume": false,
    "out_dir": "experiments\\synthetic\\uncertain_w_cem_qr_hybrid_anchor_5seeds_20260516"
  },
  "settings": {
    "lh_q5_train1000": {
      "family": "LH",
