...
`2026-05-18 - uncertain_w_cem_qr_svd_lh_seed0_20260518` (smoke check).
...
```json
{
  "started": "2026-05-17 23:40:57",
  "finished": "2026-05-17 23:41:01",
  "device": "cuda",
  "args": {
    "settings": "lh_q5_train1000",
    "variants": "qr_alt_hya0.25_refresh10_self_cem2_nstd0.1_rank0.1_svd_kcov0.1",
    "seed_start": 0,
    "num_exp": 1,
    "projection_init": "pls",
    "max_test": 5,
    ...
    "resume": false,
    "out_dir": "experiments\\synthetic\\uncertain_w_cem_qr_svd_lh_smoke_20260518"
  },
  "settings": {
    "lh_q5_train1000": {
      "family": "LH",
