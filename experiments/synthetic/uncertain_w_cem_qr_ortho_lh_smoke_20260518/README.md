...
`2026-05-18 - uncertain_w_cem_qr_ortho_lh_seed0_20260518` (smoke check).
...
```json
{
  "started": "2026-05-17 23:20:52",
  "finished": "2026-05-17 23:20:58",
  "device": "cuda",
  "args": {
    ...
    "resume": false,
    "out_dir": "experiments\\synthetic\\uncertain_w_cem_qr_ortho_lh_smoke_20260518"
  },
  "settings": {
    "lh_q5_train1000": {
      "family": "LH",
