...
This directory is only the small compile/runtime smoke check for rank-hybrid
retrieval.  The full LH seed0 screen is in
...
```json
{
  "started": "2026-05-16 22:20:57",
  "finished": "2026-05-16 22:21:02",
  "device": "cuda",
  "args": {
    "settings": "lh_q5_train1000",
    "variants": "qr_alt_hyra0.5_refresh2_self_cem1_nstd0.1_rank0.01_kcov0.1",
    "seed_start": 0,
    "num_exp": 1,
    "projection_init": "pls",
    "max_test": 6,
    ...
    "resume": false,
    "out_dir": "experiments\\synthetic\\uncertain_w_cem_qr_rankhybrid_smoke_20260517"
  },
  "settings": {
    "lh_q5_train1000": {
      "family": "LH",
  ...
  "variants": [
    "qr_alt_hyra0.5_refresh2_self_cem1_nstd0.1_rank0.01_kcov0.1"
  ],
  "n_rows": 1,
  "n_ok": 1,
  "n_failed": 0
