...
Note: this folder was populated in two invocations.  The first ran
`qr_mstep_fixed_label_kcov0`, `qr_mstep_self_cem1_kcov0.1`,
`qr_alt_refresh10_self_cem1_kcov0.1`, and
`qr_alt_refresh10_self_cem2_kcov0.1` with `--qr_outer_cycles 4`.  The second
used `--resume` to append `qr_alt_refresh5_self_cem1_kcov0.1` with
`--qr_outer_cycles 8`.  `metrics.csv` and `aggregate.csv` contain all rows;
`summary.json` records the last invocation.

```json
{
  "started": "2026-05-14 15:18:31",
  "finished": "2026-05-14 15:35:01",
  "device": "cuda",
  "args": {
    "settings": "l2_q2_train1000,lh_q5_train1000",
    "variants": "qr_alt_refresh5_self_cem1_kcov0.1",
    "seed_start": 0,
    "num_exp": 1,
    "projection_init": "pls",
    "max_test": 200,
    ...
    "resume": true,
    "out_dir": "experiments\\synthetic\\uncertain_w_cem_qr_alt_l2_lh_seed0_20260514"
  },
  "settings": {
    "l2_q2_train1000": {
      "family": "L2_phantom",
  ...
  "variants": [
    "qr_alt_refresh5_self_cem1_kcov0.1"
  ],
  "n_rows": 12,
  "n_ok": 12,
  "n_failed": 0
