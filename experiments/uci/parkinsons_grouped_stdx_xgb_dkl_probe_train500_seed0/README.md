...
|---|---|---:|---:|---:|---:|---:|---:|---:|
| Parkinsons Telemonitoring | dkl_svgp | 1 | 10.0551 | 0.0000 | 7.9998 | 0.0000 | 0.155 | 5.2806 |
| Parkinsons Telemonitoring | xgb_bootstrap | 1 | 8.4385 | 0.0000 | 6.1104 | 0.0000 | 0.310 | 7.7207 |

## Command

```powershell
python experiments/uci/compare_smalltrain_multiseed_grouped.py --num_exp 1 --datasets "Parkinsons Telemonitoring" --max_total_train 500 --max_test_anchors 200 --max_train_anchors 128 --xgb_boots 30 --dkl_epochs 80 --lmjgp_steps 300 --MC_num 3 --parkinsons_standardize_x 1 --parkinsons_standardize_y 0 --out_dir experiments\uci\parkinsons_grouped_stdx_xgb_dkl_probe_train500_seed0
```
