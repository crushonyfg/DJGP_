...
```powershell
python experiments/uci/compare_smalltrain_multiseed_grouped.py --num_exp 1 --datasets "Wine Quality" --max_total_train 80 --max_test_anchors 20 --max_train_anchors 32 --xgb_boots 3 --dkl_epochs 3 --lmjgp_steps 5 --MC_num 2 --out_dir experiments\uci\smalltrain_multiseed_grouped_smoke
```
